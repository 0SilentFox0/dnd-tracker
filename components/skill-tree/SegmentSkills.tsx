...
import { SKILL_LEVELS, SkillLevel } from "@/lib/types/skill-tree";
...
export function SegmentSkills({
  ...
  return (
    <>
      {/* Коло 3 - 3 навики (найбільша частина сегменту, зовні) - початок прокачки */}
      ...
      {/* Коло 2 - 2 навики (середня частина сегменту) - відкривається після прокачки 1 навику з кола 3 */}
      <SkillCircleGroup
      ...
      {/* Коло 1 - 1 навик (найменша частина сегменту, всередині) - відкривається після прокачки 1 навику з кола 2 */}
      <SkillCircleGroup
